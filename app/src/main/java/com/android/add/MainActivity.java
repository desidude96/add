...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bttnAdd.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                String tvValue1 = textView1.getText().toString();
                int num1 = Integer.parseInt(tvValue);
                int num2 = Integer.parseInt(tvValue1);
                int sumT = sum(num1, num2);
                textView2.setText("" + sumT);
            }
